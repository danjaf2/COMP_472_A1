...
data = gsm.load('glove-wiki-gigaword-300')
...
print('--------------GloVe Wiki Embedding Top MLP Emotions------------------------')
...
X_train, X_test, y_train, y_test = train_test_split(posts_encoded, emotions_encoded, stratify=emotions_encoded,
