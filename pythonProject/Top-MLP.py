...
=======
model_grid = GridSearchCV(estimator=MLPClassifier(max_iter=300), param_grid=params, n_jobs=-1)
>>>>>>> Stashed changes
...
f.write("TOP Perceptron Sentiment Confusion Matrix")
f.write("\n")
...
#f = open("performance.txt", "a")
#f.write("TOP Perceptron Emotions Confusion Matrix")
#f.write("\n")
